 ...
 * 不过继承类需要根据要求求提供相应的函数，尤其是提供一个{@link EaseSDKModel}. 所以请实现abstract protected HXSDKModel createModel();
...
public abstract class EaseSDKHelper {
     ...
     */
    protected EaseSDKModel hxModel = null;
     ...
     */
    private static EaseSDKHelper me = null;
...
//            hxModel = new DefaultHXSDKModel(appContext);
     ...
     * @return
     */
    public static EaseSDKHelper getInstance(){
        return me;
    }
     ...
     * @return
     */
    abstract protected EaseSDKModel createModel();
